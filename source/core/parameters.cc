  ...
  Mesh::declare_parameters(ParameterHandler &prm)
  {
    prm.enter_subsection("mesh");
    {
      prm.declare_entry(
        ...
        "dealii",
        Patterns::Selection(
          "gmsh|dealii|periodic_hills|cylinder|radial_injector"),
        "Type of mesh "
        "Choices are <gmsh|dealii|periodic_hills|cylinder|radial_injector>.");
    ...
    {
      {
        ...
        if (op == "gmsh")
          ...
          type = Type::cylinder;
        else if (op == "radial_injector")
          type = Type::radial_injector;
        else
